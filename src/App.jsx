  ...
  return (
    <section className='bg-white dark:bg-gray-900'>
      <div className='py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16'>
        <h1 className='mb-4 text-4xl font-extrabold tracking-tight leading-none text-black-90 md:text-5xl lg:text-6xl dark:text-white'>
          Age Calculator
        </h1>
        <p className='mb-8 text-lg font-normal text-black-50 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-40'>
